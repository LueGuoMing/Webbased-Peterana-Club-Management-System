    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('member.clubs.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Event Index</a>
            </div>

            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('member.advertisements.store') }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="sm:col-span-6 pt-5">
                          ...
                          <div class="mt-1">
                            ...
                            value ="{{ Auth::user()->club->id as $club->id }}"
                            disabled="disabled"
                        ...
                        <div class="sm:col-span-6 pt-5">
                          ...
                          <div class="mt-1">
                            <select id="clubs" name="clubs[]" class="form-multiselect block w-full mt-1"
                              multiple>
                              @isset (Auth::user()->club->id as $club->id)
                              <option value="{{ $club->id }}">{{ $club->name }}</option>
                              @endisset
                            </select>
                          </div>
                      ...
                      <div class="mt-6 p-4">
                      <button type="submit" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white">Create</button>
                      </div>
                    </form>
                  </div>
            </div>
