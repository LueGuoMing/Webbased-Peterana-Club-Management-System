    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="m-2 p-2 bg-slate-100 rounded">
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('member.advertisements.update', $advertisement->id) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PATCH')
                  ...
                  <div class="sm:col-span-6 pt-5">
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div>
                        <img class="w-32 h-32" src="{{ Storage::url($advertisement->image) }}">
                      </div>
                      <div class="mt-1">
