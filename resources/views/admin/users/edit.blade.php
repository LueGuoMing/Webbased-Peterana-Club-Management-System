    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('users.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Club Index</a>
            </div>
                      ...
                      <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                          <select id="club_id" name="club_id" class="form-multiselect block w-full mt-1">
                            ...
                            <option value="{{ $club->id }}" selected="{{ $user->club_id }}">{{ $club->name }} </option>
                            @endforeach
                          </select>
                        </div>
                        @error('club_id')
