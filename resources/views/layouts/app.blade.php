        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-slate-100 md:w-64 dark-mode:text-gray-200 dark-mode:bg-gray-800" x-data="{ open: false }">
                <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                    <a href="#" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">{{ Auth::user()->name }}</a>
                    ...
                    <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
                        ...
                        <x-responsive-nav-link :href="route('member.clubs.index')" :active="request()->routeIs('member.clubs.index')">
                        <span>
                        ...
                        <x-responsive-nav-link :href="route('member.rooms.index')" :active="request()->routeIs('member.rooms.index')">
                        ...
                        <x-responsive-nav-link :href="route('member.bookings.index')" :active="request()->routeIs('member.bookings.index')">
